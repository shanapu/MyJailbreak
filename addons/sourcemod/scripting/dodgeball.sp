...
public void OnPluginStart()
{
	...
	gc_sSoundStartPath = AutoExecConfig_CreateConVar("sm_dodgeball_sounds_start", "music/myjailbreak/start.mp3", "Path to the soundfile which should be played for a start countdown.");
	gc_bOverlays = AutoExecConfig_CreateConVar("sm_dodgeball_overlays_enable", "1", "0 - disabled, 1 - enable overlays", FCVAR_NOTIFY, true, 0.0, true, 1.0);

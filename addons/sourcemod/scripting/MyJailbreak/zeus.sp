...
public void OnPluginStart()
{
	...
	gc_bSetABypassCooldown = AutoExecConfig_CreateConVar("sm_zeus_cooldown_admin", "1", "0 - disabled, 1 - ingnore the cooldown when admin/vip set zeus round", _, true, 0.0, true, 1.0);

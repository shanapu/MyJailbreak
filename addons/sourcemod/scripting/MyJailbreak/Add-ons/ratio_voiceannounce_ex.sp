/*
 * MyJailbreak - Ratio - Voiceannounce_EX support.
 * by: shanapu
...
public Plugin myinfo = {
	name = "MyJailbreak - Ratio - Voiceannounce_EX",
	author = "shanapu, Addicted, good_live",
	description = "Check with Voiceannounce_EX if player has already spoken allow move to guards",
...
public Action MyJailbreak_OnJoinGuardQueue(int client)
{
	if (!g_bSpeak[client])
	{
		CPrintToChat(client, "%s %t", g_sPrefixR, "ratio_voice");
